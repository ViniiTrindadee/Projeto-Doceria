  ...
  <main role="main" class="container">
    <div class="row">
      <div class="col-md-10 blog-main">
        ...
        <div class="blog-post">
          <h4>Sua mensagem foi recebida com sucesso.<br>Nossa equipe de atendimento irá analisá-la em até 48 horas.</h4><br>
          <p><b>Nome:</b> <?php echo $inputNome ?></p>
          <p><b>E-mail:</b> <?php echo $inputEmail ?></p>
          <p><b>Telefone:</b> <?php echo $inputTelefone ?></p>
          <p><b>Mensagem:</b> <?php echo $inputMensagem ?></p>
